 ...
 */
public class CanceledAdapter extends BaseAdapter {
    Context context;
    List<IndentBean>list;
    public CanceledAdapter(Context context,List<IndentBean>list){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view ==null){
            ...
            view = LayoutInflater.from(context).inflate(R.layout.adapter_canceled_item,null);
